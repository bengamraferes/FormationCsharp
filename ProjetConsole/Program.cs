...
Formation c#";
            ...
            Console.WriteLine("Somme = " +MesMethodes.SommmeTab(tableau));
            Console.WriteLine("moyenne = " + MesMethodes.moyenneTab(tableau));
            Console.WriteLine("petit = " + MesMethodes.ElementPetit(tableau));
